...
class RAGAgent:
    ...
    async def generate_response(self, query: str, context: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        prompt = f"You are a helpful assistant for a Physical AI and Humanoid Robotics textbook. Answer the user's question based ONLY on the provided context. If you cannot find the answer in the context, politely state that you don't have enough information.\n\nContext:\n{context_str}\n\nQuestion: {query}"
